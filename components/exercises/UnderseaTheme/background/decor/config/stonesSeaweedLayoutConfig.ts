...
export const STONE_BASE_WIDTH = 72;
export const STONE_BASE_HEIGHT = 56;
export const SHADOW_COLOR = [0.02, 0.06, 0.12] as const;
export const SHADOW_OPACITY = 0.70;
