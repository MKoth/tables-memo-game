...
import type { JellyfishSizing, LayoutParticle } from '../layout/computeJellyfishLayout';
import {
  HEADER_COL_A,
  HEADER_COL_B,
  HEADER_ROW_A,
...
export function createCellConfigs(table: TableData, sizing: JellyfishSizing): CellConfig[] {
