...
export const BEE_SHADOW_OFFSET_FLYING_X = 10;
export const BEE_SHADOW_OFFSET_FLYING_Y = -50;
export const BEE_SHADOW_SIZE_SITTING = 1.0;
export const BEE_SHADOW_SIZE_FLYING = 1.3;
export const BEE_SHADOW_OPACITY_SITTING = 0.5;
export const BEE_SHADOW_OPACITY_FLYING = 0.2;
