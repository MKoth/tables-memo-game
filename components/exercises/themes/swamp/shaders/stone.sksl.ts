...
export const stoneDefaults = {
  /** Caustic pattern snaps per second — higher = faster dancing light. */
  switchRate: 6.0,
  /** RGB multiplier for stone tint — murky green/brown. */
  underwaterTint: [0.5, 0.7, 0.4] as const,
  /** Tint intensity — 0 = none, 1 = full. */
  underwaterTintStrength: 0.55,
  ...
  voronoiCount: 3,
  /** Voronoi cell density per layer — tuned for stone-sized sprites. */
  voronoiScale: [0.5, 1.0, 4.0],
  /** Caustic beam strength per layer. */
  voronoiIntensity: [0.08, 0.06, 0.04],
