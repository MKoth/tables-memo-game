...
import { WORD_SPRITE_TINT_PRESET_INDEX } from '../presets/wordSpriteTintPresets';
import {
  BIAS_DRAG_SENS,
  BIAS_FLING_SENS,
  MAX_FLING_MS,
...
import type { LayoutBounds, LayoutParticle } from '../layout/computeWordSpriteLayout';
import type { WordSpriteSoundKind } from '../types';
import {
  clampW,
...
} from '../worklets/wordSpriteTableWorklets';

type UseWordSpriteTableGesturesParams = {
...
export function useWordSpriteTableGestures({
  ...
  flashTranslationJs,
}: UseWordSpriteTableGesturesParams) {
