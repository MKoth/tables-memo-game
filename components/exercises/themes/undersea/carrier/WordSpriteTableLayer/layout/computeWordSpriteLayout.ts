/**
 * Screen-space wordSprite layout with strict grid order preservation.
 *
 ...
 * a wordSprite at gridCol 2 is always between cols 1 and 3 on screen.
 */

import type { LayoutBounds } from '../../../../../core/layout/layoutBounds';
import { computeWordSpriteFontScale } from '../../wordSpriteVisualTokens';
...
export { REFERENCE_BODY_BELL_SIZE } from '../../wordSpriteVisualTokens';

export type WordSpriteSizing = {
  bodyBellSize: number;
...
export type WordSpriteSizingInput = {
  zoneWidth: number;
  zoneHeight: number;
  nGridCols: number;
  nGridRows: number;
 ...
 */
export function computeWordSpriteSizing(input: WordSpriteSizingInput): WordSpriteSizing {
  ...
  return {
    ...
    fontScale: computeWordSpriteFontScale(bodyBellSize),
  };
}
