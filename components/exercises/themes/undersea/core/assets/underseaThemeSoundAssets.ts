...
export const UNDERSEA_SOUND_ASSETS = {
  ...
  successClick: require('../../../../../assets/sounds/undersea_theme/success_click.mp3'),
  wrongClick: require('../../../../../assets/sounds/undersea_theme/wrong_click.wav'),
  primaryClick: require('../../../../../assets/sounds/undersea_theme/primary_click.wav'),
  fanfare: require('../../../../../assets/sounds/undersea_theme/success-fanfare-trumpets.mp3'),
} as const;
