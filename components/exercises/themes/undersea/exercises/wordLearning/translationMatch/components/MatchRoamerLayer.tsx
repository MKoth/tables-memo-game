...
import { RoamerFishLayer } from '../../../../roamer/roamerFish/RoamerFishLayer';
import { RoamerCaptureOverlay } from '../../../../roamer/capture/RoamerCaptureOverlay';
import {
  BubblePhase,
  BurstIntent,
  useBubbleAnimation,
} from '../../../../roamer/bubbles/useBubbleAnimation';
import type { KeepOutDisk } from '../../../../../../wordLearning/translationMatch/domain/wordSpriteRoaming';
import { useRoamerCaptureSharedState } from '../../../../roamer/RoamerSwimZone/hooks/useRoamerCaptureSharedState';
import type {
  RoamerCaptureSharedState,
  RoamerFishSimulation,
} from '../../../../roamer/simulation/useRoamerFishSimulation';
import {
  useRoamerFishSimulation,
} from '../../../../roamer/simulation/useRoamerFishSimulation';
import { BUBBLE_DIAMETER_RATIO } from '../../../../roamer/RoamerSwimZone/types';
import { releaseCapturedFishWorklet } from '../../../../roamer/capture/releaseFishToPool';
import type { MatchSessionController } from '../../../../../../wordLearning/translationMatch/domain/matchSessionController';
import type { RoamerTapData } from '../wordSprite/useCombinedMatchGestures';

const MATCH_ROAMER_Z = 3;
const MATCH_BUBBLE_Z = 5;

export type MatchRoamerLayerProps = {
  words: string[];
  ...
  tapDataRef?: React.MutableRefObject<RoamerTapData | null>;
  interactive?: boolean;
  keepOutDiskSv?: SharedValue<KeepOutDisk | null>;
};

export function MatchRoamerLayer({
  words,
  sounds,
  sessionController,
  triggerEscapeRef,
  ...
  const simRef = useRef<RoamerFishSimulation>(null!);
