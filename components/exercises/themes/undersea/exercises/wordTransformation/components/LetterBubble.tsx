...
import { BubbleInstance } from '../../../roamer/bubbles/BubbleInstance';
import {
  BUBBLE_BURST_DURATION_MS,
  BUBBLE_IDLE_WOBBLE,
  WORD_TRANSFORMATION_BUBBLE_OPACITY,
} from '../../../roamer/bubbles/bubbleAnimPresets';
import { WORD_LETTER_ENTER_DURATION_MS } from '../../../../../wordTransformation/insertAnimationTiming';
import type { BubbleAnimState } from '../../../roamer/bubbles/bubbleAnimTypes';
