...
export function useRoamerCaptureSharedState(initialWidth: number) {
  ...
  const releaseContextSv = useSharedValue<{
    runtimeEntries: import('../../simulation/captureTypes').RoamerFishSimulation['runtimeEntries'];
    sharedPositions: import('../../simulation/captureTypes').RoamerFishSimulation['sharedPositions'];
    captureState: import('../../simulation/captureTypes').RoamerCaptureSharedState;
  } | null>(null);
...
export type RoamerCaptureSharedStateBundle = ReturnType<typeof useRoamerCaptureSharedState>;
